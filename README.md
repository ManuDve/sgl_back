...
El sistema incluye un módulo de notificaciones con reintentos automáticos, gestión para reagendar y cancelar consultas, un registro de auditoría de emails enviados e integración con Transbank para pagos en línea. Tanto las notificaciones como el flujo de gestión de consultas se pueden realizar mediante la API REST o un chatbot de WhatsApp.
